...
export default function App() {
  ...
  useEffect(() => {
    ...
    return () => unsubscribe();
  }, [isAuthReady, userId, error]); // Jab auth state ya userId badle tab re-run ho
  ...
  const copyPrompt = (text) => {
    try {
      // document.execCommand('copy') is iframe environments ke liye behtar hai
                  ...
                  {img.isUnlocked ? (
                    ...
                    <div className="mt-3">
                      <p className="text-gray-500 text-sm blur-sm select-none mb-3">
                        Yeh prompt ad dekhne ke baad hi unlock hoga...
                      </p>
                      <button
