...
export default function App() {
  ...
  useEffect(() => {
    ...
    if (showAd) {
      // Reset timer agar showAd true hua hai
      if (adTimer > 0) {
                ...
                <div className="relative aspect-video group">
                  <img 
                    ...
                    onError={(e) => {
                      ...
                      e.target.src = `https://placehold.co/800x450/4B5563/FFFFFF?text=${encodeURIComponent(img.title || 'Image+Not+Found')}`;
                    }}
                  />
                  ...
                  {img.isUnlocked ? (
                    ...
                    <div className="mt-3">
                      ...
                      <button
                        ...
                        className="w-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white py-2.5 rounded-lg font-semibold flex items-center justify-center transition-all"
                      >
